...
- Compiti scritti 2017/18 prof. P. Vicig avuti da Fabio Sirotich (che ringraziamo)
- Appunti corso del 2009
- Dispensa Prof. S. Holzer
...
- Link Datacamp
- Libro "R Cookbook" di P. Teetor
- Tesina "Analisi delle vendite di videogiochi" e sua presentazione
- Testo degli appelli
- 1 Database relazionali: pdf e docx
- 2 Data science: pdf e docx
- 3 Network science: pdf e docx
- 4 Dati semistrutturati and XML: pdf e docx
- 5 Text mining: pdf e docx
- 6 Big Data and IoT: pdf e docx
- 7 Collaborate and communication: pdf e docx
- Link a complementi di tecnologie Web (XML)
- Link to caffè XML (DTD, XPath, XQuery) sintetizzato in pdf e docx. Infine un link cnr
- Automi: Dispensa Automi (Dorovier) pg 31-48, e sintesi su GitHub
...
- Riassunto del Metodo Contabile a cura di Marco Pasut (che ringraziamo)
- Piano dei conti (prof. Grisi)
- Alcuni schemi per ripasso
...
- Domande esami orali 2018/19
- "Statistica - Un'introduzione all'impostazione Bayesiana" dei prof. Daboni e Wedlin
- Dispensa su Moodle2 prof. A. Wedlin
...
- ML Algorithms Periodic Table
- Link al corso MOOC di Statistical learning (Standford UNiversity) e Link alle slides corso Statistical learning (molto usate nel corso a Ts)
...
- Grafico di una funzione (online)
- Calcolo delle derivate parziali (online)
